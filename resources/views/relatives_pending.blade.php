        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="content-page-title">
                    Запросы на отношение ({{ $list->count() }})
                </div>


                @if($list->count() == 0)
                    <div class="alert-message alert-message-danger">
                        <h4>Запросов на отношение нету.</h4>
                    </div>
                @else
                    <div class="row">
                                        ...
                                        <div class="front">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="bottom" id="approve-buttons-{{ $relation->id }}">
                                                    ...
                                                    <div class="text-danger denied" style="display: none"><i class="fa fa-times"></i> Запрос отменен!</div>
                                                    <a href="javascript:;" class="btn btn-success approve-button btn-sm" onclick="relativeRequest(1, {{ $relation->id }})"><i class="fa fa-check"></i> Принять</a>
                                                    <a href="javascript:;" class="btn btn-danger approve-button btn-sm" onclick="relativeRequest(2, {{ $relation->id }})"><i class="fa fa-times"></i> Отменить</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
